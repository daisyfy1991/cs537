...
silent only
cd /afs/cs.wisc.edu/p/course/cs537-remzi/handin/yfang/p3/xv6
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 kernel/vm.c
badd +0 ctests/shmem_access_invalid_input.c
badd +0 user/user.h
argglobal
silent! argdel *
argadd kernel/vm.c
edit ctests/shmem_access_invalid_input.c
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 397 - ((29 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
397
